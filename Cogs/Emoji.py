...
class Emoji(commands.Cog):
    ...
    async def addemoji(self, ctx, *, emoji = None, name = None):
        ...
        Contoh menambahkan emoji dari server lain jika kalian bukan pengguna nitro
        • acx!addemoji :python:769542296152309770 Uler piton'''
