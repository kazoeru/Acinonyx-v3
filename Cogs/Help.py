...
HelpMsg = """> Bot ini masih dalam tahap pengembangan, dan masih banyak command yang harus dikembangkan
> 
> __**Welcome & Goodbye Message**__
...
> __**Chat dengan bot**__
> `chat`,`setchatchannel`
> __**Reddit image**__
> `reddit`
> __**Utils**__
> `rolecount`,`whohas`,`emptyroles`,`roles`,`rolecall`,`avi`,`messages`,`allmessages`,`firstjoin`,`firstservers`,`listservers`,`topservers`,`users`,`serverinfo`,`botinfo`,`cloc`,`ping`,`servers`
> __**Invite**__
> `invite`
> 
> Masih ada lebih dari 200+ command di bot ini
> Kamu bisa melihat command lainnya **[disini](https://github.com/acinonyx-esports/Acinonyx-Bot/wiki/SELAMAT-DATANG-DI-ACINONYX-BOT)**
> NB : Tapi belum semua command ditulis sabar yaa """
