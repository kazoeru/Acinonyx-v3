...
class Encode(commands.Cog):
    ...
    async def color(self, ctx, *, value = None):
        ...
        em = discord.Embed(color = 0XFF8C00, description =  "> Melihat informasi kode warna.\n> \n"
                                                            ...
                                                            .format(ctx.prefix,
                                                                    ...
                                                                    ctx.prefix,
                                                                    ctx.prefix))
        em.set_author(name = "Color", url = "https://acinonyxesports.com/", icon_url = "https://cdn.discordapp.com/attachments/518118753226063887/725569194304733435/photo.jpg")
    ...
    async def hexdec(self, ctx, *, input_hex = None):
        ...
        if input_hex == None:
            ...
            em.set_author(name = "Help command hexdec", url = "https://acinonyxesports.com/", icon_url = "https://cdn.discordapp.com/attachments/518118753226063887/725569194304733435/photo.jpg")
            em.set_footer(text = f"Request By : {ctx.author.name}", icon_url = f"{ctx.author.avatar_url}")
        ...
        input_hex = self._check_hex(input_hex)
        if not len(input_hex):
            await ctx.send("Format salah, coba lagi.")
            return
        
        try:
            dec = int(input_hex, 16)
        except Exception:
            await ctx.send("Aku tidak dapat melakukan konversi itu!")
            return  
    ...
    async def dechex(self, ctx, *, input_dec = None):
        ...
        if input_dec == None:
            ...
            em.set_author(name = "Help command dechex", url = "https://acinonyxesports.com/", icon_url = "https://cdn.discordapp.com/attachments/518118753226063887/725569194304733435/photo.jpg")
            em.set_footer(text = f"Request By : {ctx.author.name}", icon_url = f"{ctx.author.avatar_url}")
            await ctx.send(embed = em)
            return
        ...
        try:
            ...
            await ctx.send("Input harus berupa bilangan angka.")
            return
        min_length = 2
    ...
    async def strbin(self, ctx, *, input_string = None):
        ...
        if len(msg) > 1000:
            ...
            em.set_author(name = "Kebanyakan!!!", icon_url = "https://cdn.discordapp.com/attachments/518118753226063887/725569194304733435/photo.jpg")
            em.set_footer(text = f"Request By : {ctx.author.name}", icon_url = f"{ctx.author.avatar_url}")
            await ctx.send(embed = em)
            return
        ...
        em.set_author(name = "Hasil Binary", url = "https://acinonyxesports.com/", icon_url = "https://cdn.discordapp.com/attachments/518118753226063887/725569194304733435/photo.jpg")
        em.set_footer(text = f"Request By : {ctx.author.name}", icon_url = f"{ctx.author.avatar_url}")
        await ctx.send(embed = em)
    ...
    async def binstr(self, ctx, *, input_binary = None):
        ...
        if input_binary == None:
            ...
            em.set_author(name = "Help command binstr", url = "https://acinonyxesports.com/", icon_url = "https://cdn.discordapp.com/attachments/518118753226063887/725569194304733435/photo.jpg")
            em.set_footer(text = f"Request By : {ctx.author.name}", icon_url = f"{ctx.author.avatar_url}")
            await ctx.send(embed = em)
            return
        # Clean the string
