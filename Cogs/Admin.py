...
class Admin(commands.Cog):
    ...
    async def defaultchannel(self, ctx):
        ...
        if targetChan == None:
            ...
            if default == None:
                ...
                em.set_author(name = "Default channel list", url = "https://acinonyxesports.com", icon_url = "https://cdn.discordapp.com/attachments/518118753226063887/725569194304733435/photo.jpg")
                em.set_thumbnail(url = "{}".format(ctx.message.guild.icon_url))
                em.set_footer(text = "Saat mengetik command, tanda [] tidak usah digunakan\nRequest by : {}".format(ctx.author.name), icon_url = "{}".format(ctx.author.avatar_url))
                msg = em
        else:
    ...
    async def xpreservelimit(self, ctx, *, limit = None):
                ...
                em = discord.Embed(color = 0XFF8C00,
                                   description = "> Server *{}*\n"
                                                 ...
                                                 .format(ctx.guild,
                                                         ctx.prefix,
                                                         ctx.prefix))
                em.set_author(name = "Xp reserve limit", url = "https://acinonyxesports.com", icon_url = "https://cdn.discordapp.com/attachments/518118753226063887/725569194304733435/photo.jpg")
                em.set_footer(text = "Saat mengetik command, tanda [] tidak usah digunakan\nRequest by : {}".format(ctx.author.name), icon_url = "{}".format(ctx.author.avatar_url))
        ...
        try:
            ...
            await channel.send("Batas harus berupa bilangan angka.")
            return
    ...
    async def xplimit(self, ctx, *, limit = None):
                ...
                em = discord.Embed(color = 0XFF8C00,
                                   description = "> Server *{}*\n"
                                                 ...
                                                 .format(ctx.guild,
                                                         ...
                                                         ctx.prefix,
                                                         server_lim))
                em.set_author(name = "Xp Limit", url = "https://acinonyxesports.com", icon_url = "https://cdn.discordapp.com/attachments/518118753226063887/725569194304733435/photo.jpg")
                em.set_footer(text = "Saat mengetik command, tanda [] tidak usah digunakan\nRequest by : {}".format(ctx.author.name), icon_url = "{}".format(ctx.author.avatar_url))
                await ctx.send(embed=em)
        ...
        try:
            ...
            await channel.send("Harus berupa bilangan angka.")
            return

        if limit < 0:
            self.settings.setServerStat(ctx.guild, "XPLimit", None)
            await ctx.send("Xp limit dihapus!")
        else:
    ...
    async def setxp(self, ctx, *, member = None, xpAmount : int = None):
        ...
        em = discord.Embed(color = 0XFF8C00,
                           description = "> Set batas limit xp untuk member yang dimention\n"
                                         ...
                                         "> `{}setxp [member] [jumlah]`\n"
                                         .format(ctx.prefix))
        em.set_author(name = "Set Xp", url = "https://acinonyxesports.com", icon_url = "https://cdn.discordapp.com/attachments/518118753226063887/725569194304733435/photo.jpg")
        em.set_footer(text = "Saat mengetik command, tanda [] tidak usah digunakan\nRequest by : {}".format(ctx.author.name), icon_url = "{}".format(ctx.author.avatar_url))
        usage = em
    ...
    async def setxpreserve(self, ctx, *, member = None, xpAmount : int = None):
        ...
        em = discord.Embed(color = 0XFF8C00,
                           description = "> Set batas limit perolehan xp untuk member yang dimention\n"
                                         ...
                                         .format(ctx.prefix))
        em.set_author(name = "Set xp Reserve", url = "https://acinonyxesports.com", icon_url = "https://cdn.discordapp.com/attachments/518118753226063887/725569194304733435/photo.jpg")
        em.set_footer(text = "Saat mengetik command, tanda [] tidak usah digunakan\nRequest by : {}".format(ctx.author.name), icon_url = "{}".format(ctx.author.avatar_url))
        usage = em
    ...
    async def setdefaultrole(self, ctx, *, role : str = None):
        """Menyetel default role atau posisi untuk penetapan auto-role."""
        author  = ctx.message.author
        server  = ctx.message.guild
        channel = ctx.message.channel
        ...
        em.set_author(name = "Set default role", url = "https://acinonyxesports.com", icon_url = "https://cdn.discordapp.com/attachments/518118753226063887/725569194304733435/photo.jpg")
        em.set_footer(text = "Saat mengetik command, tanda [] tidak usah digunakan\nRequest by : {}".format(ctx.author.name), icon_url = "{}".format(ctx.author.avatar_url))
    ...
    async def addxprole(self, ctx, *, role = None, xp : int = None):
        ...
        em = discord.Embed(color = 0XFF8C00,
                           description = "> menambahkan role dari list promotion/demotion\n"
                                         ...
                                         .format(ctx.prefix))
        em.set_author(name = "Set xp member", url = "https://acinonyxesports.com", icon_url = "https://cdn.discordapp.com/attachments/518118753226063887/725569194304733435/photo.jpg")
        em.set_footer(text = "Saat mengetik command, tanda [] tidak usah digunakan\nRequest by : {}".format(ctx.author.name), icon_url = "{}".format(ctx.author.avatar_url))
        usage = em
    ...
    async def removexprole(self, ctx, *, role = None):
        ...
        em = discord.Embed(color = 0XFF8C00,
                           description = "> Menghapus role dari list promotion/demotion\n"
                                         ...
                                         "> **Penggunaan**\n"
                                         "> `{}removexprole [role]`\n".format(ctx.prefix))
        em.set_author(name = "Remove xp Role", url = "https://acinonyxesports.com", icon_url = "https://cdn.discordapp.com/attachments/518118753226063887/725569194304733435/photo.jpg")
        em.set_footer(text = "Saat mengetik command, tanda [] tidak usah digunakan\nRequest by : {}".format(ctx.author.name), icon_url = "{}".format(ctx.author.avatar_url))
        usage = em
    ...
    #                                               ctx.prefix,
    #                                               ctx.prefix))
    #         em.set_author(name = "Set link role", url = "https://acinonyxesports.com", icon_url = "https://cdn.discordapp.com/attachments/518118753226063887/725569194304733435/photo.jpg")
    #         em.set_footer(text = "Saat mengetik command, tanda [] tidak usah digunakan\nRequest by : {}".format(ctx.author.name), icon_url = "{}".format(ctx.author.avatar_url))
    #         msg = em
    ...
    async def setrules(self, ctx, *, rules : str = None):
        """Menulis rule di server masing-masing (bot-admin only)."""
    ...
    async def lock(self, ctx):
        ...
        if isLocked:
            ...
            em = discord.Embed(color = 0XFF8C00,
                               description = "> Bot telah di lock, sekarang bot hanya menerima command dari admin member")
            em.set_author(name = "Admin lock on", url = "https://acinonyxesports.com", icon_url = "https://cdn.discordapp.com/attachments/518118753226063887/725569194304733435/photo.jpg")
            em.set_footer(text = "Saat mengetik command, tanda [] tidak usah digunakan\nRequest by : {}".format(ctx.author.name), icon_url = "{}".format(ctx.author.avatar_url))
            msg = em
