...
def getUserTime(member, settings, time = None, strft = "%d-%m-%Y %I:%M %p", clock = True, force = None):
...
def getTimeFromOffset(offset, t = None, strft = "%d-%m-%Y %I:%M %p", clock = True):
...
def getTimeFromTZ(tz, t = None, strft = "%d-%m-%Y %I:%M %p", clock = True):
